...
考试自动答题脚本：用 DeepSeek AI 多温度投票 + 分歧仲裁替代本地题库，无需维护题库即可应对任意题目。
...
1. 登录考试页面，进入答题界面
2. 打开浏览器开发者工具 (备注，大家可以在打开考试页面之后，可以使用快捷键 `Ctrl + Shift + J` 直接打开控制台，参照原本项目的说明文档，找到控制台的位置。只不过大家不需要在找paper那个frame，打开控制台之后直接输入代码就可以了)
